...
<?php
  ...
  */
  ...
  if(empty($admin))
  {
    $_SESSION['error'] = "Không tồn tại người quản trị.";
    redirect_to('index.php');
  }
        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <div class="box-body">
                    ...
                    <form action="<?php echo'../../controller/admin/AdminController.php?action=edit&id='.$value['id'] ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        <div class="form-group col-md-12 col-sm-12 col-xs-12 ">
                            <div class="col-md-3 col-sm-6 col-xs-12 ">
                                 <label for="exampleInputEmail1">Họ Tên<sup class="obligatory">(*)</sup></label>
                            </div>
                            <div class=" form-group  col-md-6 col-sm-6 col-xs-12 ">
                                <input type="text" name="name" class="form-control" required="required"  placeholder=" " value="<?php echo isset($value['name'])? $value['name']:""  ?>" tabindex="1" maxlength="">
                        ...
                        <div class="form-group col-md-12 col-sm-12 col-xs-12 ">
                            ...
                            <div class=" form-group  col-md-6 col-sm-6 col-xs-12 ">
                                <input type="Email" name="email" class="form-control"  placeholder="" value="<?php echo isset($value['email'])? $value['email']:""  ?>" tabindex="1" maxlength="">
                                <span class="text-danger"><p></p></span>
                            </div>
                        ...
                        <div class="form-group col-md-12 col-sm-12 col-xs-12 ">
                            ...
                            <div class=" form-group  col-md-6 col-sm-6 col-xs-12 ">
                                <input type="text" name="phone" class="form-control"  placeholder="" value="<?php echo isset($value['phone'])? $value['phone']:""  ?>" tabindex="1" maxlength="">
                                <span class="text-danger"><p></p></span>
                            </div>
                            <div class="col-md-3 col-sm-3 col-xs-0 ">
                        ...
                        <div class="form-group col-md-12 col-sm-12 col-xs-12 ">
                            ...
                            <div class=" form-group  col-md-6 col-sm-6 col-xs-12 ">
                                <input type="text" name="address" class="form-control"  placeholder="" value="<?php echo isset($value['address'])? $value['address']:""  ?> " tabindex="1" maxlength="">
                                <span class="text-danger"><p></p></span>
                            </div>
                            <div class="col-md-3 col-sm-3 col-xs-0 ">
                        ...
                        <div class="form-group col-md-12 col-sm-12 col-xs-12 ">
                            ...
                            <div class=" form-group  col-md-6 col-sm-6 col-xs-12 ">
                                <input type="radio" name="status" id="show_home2" value="1" <?php
                            if ($value['status'] == 1) {
                              # code...
                              echo "checked='checked'";
                            }
                           ?>  > <span>Hiển thị</span>
                                <input type="radio" name="status" id="show_home2" value="2"  <?php
                            if ($value['status'] == 2) {
                              # code...
                              echo "checked='checked'";
                            }
                            ...
                            <div class=" form-group  col-md-6 col-sm-6 col-xs-12 ">
                                <input type="file" id="uploadfile" name="image"  value="" placeholder = "" onchange="readURL(this);" >
                                  <div class="preview showimg" id="thumbbox" >
                                      <img id="thumbimage"  src="<?php echo url().'upload/admin/'.$value['avata']; ?>"  width="30%" alt="Image preview...">
                        ...
                        <div class="form-group col-md-12 col-sm-12 col-xs-12 ">
                            ...
                            <div class=" form-group  col-md-6 col-sm-6 col-xs-12 ">
                                <button type="submit" class="btn bg-olive btn-flat margin">Chỉnh sửa</button>
                            </div>
                            <div class="col-md-3 col-sm-3 col-xs-0 ">
